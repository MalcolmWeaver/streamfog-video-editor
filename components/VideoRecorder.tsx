...
const VideoRecorder: React.FC = () => {
    ...
    const startRecording = () => {
        ...
        let opts: MediaRecorderOptions = { 
            ...
            videoBitsPerSecond: 8000000, // 8Mbps - adjust based on needs
            audioBitsPerSecond: 128000   // 128kbps audio
        };

        // Prefer H.264 for better compatibility and quality
        if (MediaRecorder.isTypeSupported('video/mp4; codecs="avc1.42E01E"')) {
            opts = { 
                mimeType: 'video/mp4; codecs="avc1.42E01E"',
                videoBitsPerSecond: 10000000, // 10Mbps for H.264
                audioBitsPerSecond: 128000
            };
        }

        // Try higher quality H.264 profile if supported
        if (MediaRecorder.isTypeSupported('video/mp4; codecs="avc1.640028"')) {
            opts = { 
                mimeType: 'video/mp4; codecs="avc1.640028"', // High Profile
